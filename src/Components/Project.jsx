    ...
    className="bg-white py-10">
      <div className="relative w-full max-w-none md:max-w-[1200px] mx-auto bg-white rounded-lg p-4 border-2 border-black hover:shadow-lg transition duration-500 ease-in-out"> 
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {projects.map((project, index) => (
           <div 
           key={index} 
           className="bg-white p-4 rounded-md border-2 border-black hover:shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-200 cursor-pointer"
           style={{ height: '400px' }} 
         >
      ...
      {selectedProject && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg border-2 border-black max-w-6xl w-full relative flex flex-col md:flex-row">
